    ...
    return (
        <>
            ...
            <div className="mx-4 my-8">
                ...
                <div className="flex mt-8 h-[500px] overflow-auto overflow-y-hidden box-border px-2 py-2">
                    <div className="relative mr-4">
                        <img
                            ...
                            <div className="w-10 h-10 mt-2 relative float-left">
                                {like ?
                                    <svg
                                        ...
                                        className="w-8 h-8 absolute top-1 left-0 fill-[#ff0000]"
                                        xmlns="http://www.w3.org/2000/svg"
                                        height="1em"
                                        viewBox="0 0 512 512">
                                ...
                                <button
                                    onClick={likecheck}
                                    className="w-10 h-10 mt-2 relative float-left">
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="relative mr-4">
                        ...
                        />
                        <p className="font-semibold mt-2">LINNMON 린몬 / ADILS 아딜스</p>
                    ...
                    <div className="relative mr-4">
                        ...
                        />
                        <div className="absolute top-0 left-0 bg-[#fa0764] text-white px-1"><span className="text-xs">베스트셀러</span></div>
                        <p className="font-semibold mt-2">RÅSKOG 로스코그 </p>
                    ...
                    <div className="relative mr-4">
                        ...
                        />
                        <p className="font-semibold mt-2">UTESPELARE 우테스펠라레</p>
                        <p className="font-semibold mt-2 text-2xl">￦189,000</p>
                        <div className="bg-[#2360a5] rounded-full w-10 h-10 mt-2 mr-4 relative float-left">
                            <svg
                                onClick={() => addCart(4)}
